  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-10", children: APPS.map((app, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(AppCard, { app, index: i + 1 }, app.id)) })
      ] })
    }
  );
}
function AppCard({ app, index: index2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glow-card-wrapper w-full max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold mb-6", style: { color: "#111827" }, children: "About Bongly" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "#374151" },
                  children: "Bongly is a small indie studio from Bankura, West Bengal, India. We build simple, useful apps for everyday people — starting right here in our own backyard."
                }
              ),
